...
app.get('/', async (req, res) => {
  try {
    ...
    const locationInfo = {
      ...
      country: {
        name: country,
        flag: `<img src='https://flagcdn.com/16x12/${country?.toLowerCase()}.png' alt='${country}' width='45' height='45' />`,
        time_zone: timeZone,
      },
...
<div></div>
    ...
    <img src='https://flagcdn.com/16x12/${country?.toLowerCase()}.png' alt='${country}' width='45' height='45' />
    <script type="module">
      import {
        highlight
